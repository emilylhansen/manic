...
const StoryShowArticle = props => {
  return (
    <div className="story-show-article">
      <div className="story-show-article-author horizontal">
        <h2><u>{props.story.author}</u></h2>&nbsp;
        <h2>{props.story.source.name}</h2>&nbsp;
        <h2>{props.dateTime.date}</h2>&nbsp;
        <h2>{props.dateTime.time}</h2>
      </div>
      <div className="story-show-article-title">
        <h3><a href={props.story.url}>{props.story.title}</a></h3>
      </div>
      ...
      </div>
      {
        ...
        <div className="story-show-article-img">
          <img src={props.story.urlToImage}></img>
        </div>
      }
